            ...
            <ul className="message-zone">
                {messages.map((message) => {
                    if (message.emitterId == id) {
                        return <li style={{display:"flex", justifyContent:"start" }} key={message.id}><span style={{backgroundColor:"rgb(91,75,138,100)"}}>{message.content}</span></li>
                    }else{
                        return <li style={{display:"flex", justifyContent:"end" }} key={message.id}><span style={{backgroundColor:"rgb(91,75,138,100)"}}>{message.content}</span></li>
                    }
                })}
            </ul>
